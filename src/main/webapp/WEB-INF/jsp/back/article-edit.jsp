...
<body>
	...
	<div style="margin-top: 51px;">
		<div class="menu">
			...
			<div class="main">
				<form class="form-horizontal col-md-10 col-md-offset-1" method="post" action="${rootPath }/back/article-edit.html">
				<input type="hidden" name="id" value="${article.id }"/>
					<div class="form-group">
					  <label class="col-sm-2 control-label">标题:</label>
					  <div class="col-md-7">
					    <input type="text" class="form-control" name="title" value="${article.title }" placeholder="标题" required >
					  </div>
					</div>
					<div class="form-group">
					  <label class="col-sm-2 control-label">作者:</label>
					  <div class="col-md-7">
					    <input type="text" class="form-control" name="author" value="${article.author }" placeholder="作者" required>
					  </div>
					</div>
					<div class="form-group ">
					  <label class="col-sm-2 control-label">来源:</label>
					  <div class="col-md-7">
					    <input type="text" class="form-control" name="source" value="${article.source }" placeholder="文章来源" required>
					  </div>
					</div>
					<div class="form-group ">
					  <label class="col-sm-2 control-label">关键字:</label>
					  <div class="col-md-7">
					    <input type="text" class="form-control" name="keywords" value="${article.keywords }" placeholder="多个关键字用“,”分割" required>
					  </div>
					</div>
					<div class="form-group ">
						<label class="col-sm-2 control-label">摘要:</label>
					  <div class="col-md-7">
					    <textarea name="summary" cols="30" rows="8" class="form-control" required>${article.summary }</textarea>
					  </div>
					</div>
					
					<label class="col-sm-2 control-label" style="padding-right: 2em;">分类:</label>
					<div class="input-group col-md-7" style="margin-bottom: 15px;padding: 0 8px 0 4px">
		          		<input type="text" class="form-control col-md-5" name="category"  value="${article.category }">
					...
					<div class="form-group ">
					  ...
					  <div class="col-md-7">
					    <script id="editor" type="text/plain" style="width:100%;height:400px;" name="detail">${article.detail}</script> 
					  </div>
					</div>
					<div class="form-group">
